  ...
  return (
    <div className='flex min-h-screen flex-col items-center justify-center bg-gray-100 dark:bg-gray-900'>
      <div className='container mx-auto max-w-7xl p-6'>
        ...
        <div className='mb-6 rounded-lg bg-white p-6 shadow dark:bg-gray-800 dark:shadow-gray-700'>
          ...
          <div className='grid grid-cols-1 gap-12 md:grid-cols-2'>
            ...
            <div className='flex flex-col'>
              ...
              <div className='prose prose-sm mt-6 text-gray-700 dark:text-gray-300'>
              ...
              <div className='mt-8 space-y-4'>
                ...
                <div className='mt-8 border-t border-gray-200 pt-6 dark:border-gray-700'>
                  ...
                  <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
                    ...
                    <Link
                      href='/products'
                      className='flex items-center justify-center rounded-lg border border-gray-300 p-4 transition-colors hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-800'
                    >
                      <div className='flex flex-col items-center text-center'>
                        <svg
                          xmlns='http://www.w3.org/2000/svg'
        ...
        <div className='mt-12 rounded-lg bg-white p-6 shadow dark:bg-gray-800 dark:shadow-gray-700'>
