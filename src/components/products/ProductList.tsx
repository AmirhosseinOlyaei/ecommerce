  ...
  */
    ...
    return (
      <div className='flex min-h-[400px] items-center justify-center'>
        <div className='text-center'>
          <div className='mx-auto h-12 w-12 animate-spin rounded-full border-t-2 border-b-2 border-blue-500 dark:border-blue-400'></div>
  ...
  if (error) {
    ...
    if (error.message.includes('UNAUTHORIZED')) {
      return (
        <div className='rounded-lg bg-blue-50 p-8 text-center dark:bg-blue-900/20'>
          ...
          <a
            ...
            className='mt-4 inline-flex items-center justify-center rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600'
          >
            Sign In
          </a>
        </div>
      ...
      <div className='mx-auto'>
        <form onSubmit={handleSearch} className='flex'>
          <input
            ...
            className='w-full flex-1 rounded-l-lg border border-gray-300 bg-white px-4 py-2 text-gray-900 focus:ring-2 focus:ring-blue-500 focus:outline-none dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 dark:focus:ring-blue-400'
          />
          <button
            type='submit'
            className='rounded-r-lg bg-blue-600 px-4 py-2 text-white hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600'
          >
            Search
          </button>
        </form>
